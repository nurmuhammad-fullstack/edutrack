...
export const landing = {
  uz: {
    ...
    // apply page
    applyTitle: "Trener bo'lib qo'shilish",
    applySub: "Arizangizni qoldiring — biz tez orada bog'lanib, trenerligingizni tasdiqlab, BEPUL akkaunt ochib beramiz.",
    applyName: "Ism familiya",
    applyPhone: "Telefon raqam",
    applySport: "Sport turi / yo'nalish",
    applyMessage: "Qo'shimcha (zal, tajriba, o'quvchilar soni)",
    applySend: "Ariza yuborish",
    applySending: "Yuborilmoqda…",
    applyOkTitle: "Arizangiz qabul qilindi! ✅",
    applyOkSub: "Tez orada siz bilan bog'lanamiz. Telefoningiz yonida bo'ling.",
    applyVerifyNote: "ℹ️ Ariza akkaunt ochmaydi — biz har bir trenerni tekshirib, keyin akkaunt ochamiz.",
    applyOrTg: "yoki Telegram orqali yuborish",
    applyBack: "← Bosh sahifa",
    plans: [
  ...
  ru: {
    ...
    // apply page
    applyTitle: "Стать тренером",
    applySub: "Оставьте заявку — мы свяжемся, подтвердим, что вы тренер, и откроем БЕСПЛАТНЫЙ аккаунт.",
    applyName: "Имя и фамилия",
    applyPhone: "Номер телефона",
    applySport: "Вид спорта / направление",
    applyMessage: "Дополнительно (зал, опыт, число учеников)",
    applySend: "Отправить заявку",
    applySending: "Отправка…",
    applyOkTitle: "Заявка принята! ✅",
    applyOkSub: "Скоро свяжемся с вами. Держите телефон под рукой.",
    applyVerifyNote: "ℹ️ Заявка не открывает аккаунт — мы проверяем каждого тренера, затем открываем аккаунт.",
    applyOrTg: "или отправить через Telegram",
...
export const botMsg = {
  uz: {
    ...
    limitReached: "⚠️ O'quvchi limiti to'ldi. Tarifni oshiring.",
    studentApproved: "✅ Tabriklaymiz! Arizangiz tasdiqlandi. Endi o'quvchisiz!",
    studentRejected: "Afsuski, arizangiz rad etildi.",
    digestTitle: "🌅 Bugungi xulosa:",
    ...
    menuCabinet: "🎓 Kabinet",
    menuCabinetMsg: "Kabinetingizga o'tish uchun bosing 👇",
    menuFeedback: "💬 Fikr",
    menuLang: "🌐 Til / Язык",
  ...
  ru: {
    ...
    limitReached: "⚠️ Достигнут лимит учеников. Повысьте тариф.",
    studentApproved: "✅ Поздравляем! Ваша заявка принята. Теперь вы ученик!",
    studentRejected: "К сожалению, ваша заявка отклонена.",
    digestTitle: "🌅 Сводка на сегодня:",
    ...
    menuCabinet: "🎓 Кабинет",
    menuCabinetMsg: "Нажмите, чтобы войти в кабинет 👇",
    menuFeedback: "💬 Отзыв",
    menuLang: "🌐 Til / Язык",
...
export const dashboard = {
  uz: {
    ...
    reportNav: "📊 Hisobot",
    allTimeCollected: "Jami yig'ilgan",
    collectionRate: "To'lov darajasi",
    revenue6mo: "So'nggi 6 oy daromad",
    ...
    // debt + student profile
    debtTitle: "Qarzdorlik",
    debtNav: "💰 Qarzdorlik",
    totalDebt: "Umumiy qarz",
    debtorsCount: "Qarzdorlar",
    noDebt: "Qarzdorlar yo'q 🎉",
    monthsUnpaidSuffix: "oy to'lanmagan",
    lastPaid: "Oxirgi to'lov",
    neverPaid: "To'lov bo'lmagan",
    debtNote: "Ilovaga qo'shilgandan beri to'lanmagan oylar hisobga olinadi.",
    profileTitle: "O'quvchi",
    joined: "Qo'shilgan",
  ...
  ru: {
    ...
    reportsTitle: "Отчёты",
    reportNav: "📊 Отчёт",
    allTimeCollected: "Всего собрано",
    collectionRate: "Уровень оплат",
    revenue6mo: "Доход за 6 месяцев",
    byGroup: "По группам",
    ...
    // debt + student profile
    debtTitle: "Задолженность",
    debtNav: "💰 Долги",
    totalDebt: "Общий долг",
    debtorsCount: "Должники",
    noDebt: "Должников нет 🎉",
    monthsUnpaidSuffix: "мес. не оплачено",
    lastPaid: "Последняя оплата",
    neverPaid: "Оплат не было",
    debtNote: "Учитываются неоплаченные месяцы с момента добавления в приложение.",
    profileTitle: "Ученик",
    joined: "Добавлен",
